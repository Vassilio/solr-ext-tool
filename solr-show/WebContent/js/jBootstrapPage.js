        ...
        return this.each(function() {
            ...
            function init() {
        		...
        		if(c.maxPages==1){
        			...
        			$this.append('<li class="disabled"><a class="last" href="#">末页</a></li>');
        		}else{
        			$this.append('<li class=""><a class="next" href="#">下一页</a></li>');
        			$this.append('<li><a class="last" href="#">末页</a></li>');
        		}
...
//            	}
            ...
            function mathLastPage(maxPage, showPage){
            	var endPages=maxPage+1;
            	var startPages;
            	if(maxPage<=showPage){
            		startPages=1;
            	}else{
            		startPages=endPages-showPage;
            	}
            	var pNum = 0;
        		var html = '';
        		for(var index = startPages; index < endPages; index++) {
            ...
            function onPageBtnClick($_this) {
            	...
            	if(selectedText == '下一页' ) {
            		...
            		var selectedIndex = parseInt(selectedBtn.text());//当前页码
            		var selectNum = parseInt($this.find('li.active').attr('pNum'))+1;//下一页在本次序列中的第几位
            		//超出本次序列
